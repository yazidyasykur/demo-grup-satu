...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/demogrupsatustorefront/electronics/en",
						"https://electronics.local:9002/demogrupsatustorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/demogrupsatustorefront/electronics/en",
						"https://electronics.local:9002/demogrupsatustorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/demogrupsatustorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/demogrupsatustorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/demogrupsatustorefront/electronics/en",
						"https://electronics.local:9002/demogrupsatustorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/demogrupsatustorefront",
						"https://electronics.local:9002/demogrupsatustorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/demogrupsatustorefront",
						"https://electronics.local:9002/demogrupsatustorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/demogrupsatustorefront/electronics/en",
						"https://electronics.local:9002/demogrupsatustorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
