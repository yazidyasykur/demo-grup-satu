...
import org.demogrupsatu.storefront.forms.validation.IntheboxRegistrationValidator;
...
public abstract class IntheboxAbstractRegisterPageController extends AbstractPageController
{
    ...
    @Resource(name = "intheboxRegistrationValidator")
    private IntheboxRegistrationValidator registrationValidator;
     ...
     */
    protected String processRegisterUserRequest(final String referer, final IntheboxRegisterForm form, final BindingResult bindingResult,
