 ...
 */
package org.demogrupsatu.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(DemogrupsatuFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(DemogrupsatuFulfilmentProcessConstants.PARENT_PROCESS);
