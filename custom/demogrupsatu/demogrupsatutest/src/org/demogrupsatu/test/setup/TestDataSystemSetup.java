 ...
 */
package org.demogrupsatu.test.setup;
...
import org.demogrupsatu.test.constants.DemogrupsatuTestConstants;
import org.demogrupsatu.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = DemogrupsatuTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/demogrupsatutest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/demogrupsatutest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/demogrupsatutest/import/cstickets.impex");
			...
			importImpexFile(context, "/demogrupsatutest/import/csquotes.impex");
		}
	}
}
